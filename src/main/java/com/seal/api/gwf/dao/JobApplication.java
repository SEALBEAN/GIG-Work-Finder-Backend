...
public class JobApplication {
    ...
    //Lấy hết các các JA mà họ Apply vào JO của mình
    ...
    //Lấy hết các nhân viên (JA) bên JobMapping (Bao gồm cả những nhân viên do mình offer hay apply vào JO của mình)
