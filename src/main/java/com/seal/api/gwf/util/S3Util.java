...
public class S3Util {
    private static final String BUCKET = "gwfapp";

    public static String uploadFile(String fileName, InputStream inputStream)
            throws S3Exception, AwsServiceException, SdkClientException, IOException {
        S3Client client = S3Client.builder().build();
        String key = "Pictures/" + fileName;
        PutObjectRequest request = PutObjectRequest.builder()
                .bucket(BUCKET)
                //key la dia chi va ten file se tao
                .key(key)
                .acl("public-read")
                .build();
        ...
        return "https://gwfapp.s3.ap-southeast-1.amazonaws.com/" + key;
    }
